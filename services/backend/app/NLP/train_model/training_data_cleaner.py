...
data = pd.read_csv('train_model/training_data_set.csv', encoding =DATASET_ENCODING , names=DATASET_COLUMNS)
...
data.to_csv("train_model/clean_dataset.csv",na_rep='NULL')
